---
title: "Building"
description: "Build the public AGPL Community source edition, run tests, lint, and set up your development environment"
---

<Note>
This page builds the public Rockxy Community source edition under
AGPL-3.0-or-later. The official signed DMG is produced from a separate
downstream distribution and is not reproducible solely from this repository.
See [Rockxy Licensing](https://github.com/RockxyApp/Rockxy/blob/main/LICENSING.md) for the artifact boundary.
</Note>
