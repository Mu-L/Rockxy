...
- AI Assistant предлагает локальный анализ или модель Ollama/provider после Review Data; боковая панель включает Focus Sets и Noise Control; workspace использует нативные split view; а инспекция AI/Web3/x402 уже является текущим поведением.
...
Держите рядом независимые представления расследования одного live capture. Каждая вкладка сохраняет собственные фильтры, сортировку, выбор, scope боковой панели и состояние инспектора, разделяя proxy и захваченные транзакции.
