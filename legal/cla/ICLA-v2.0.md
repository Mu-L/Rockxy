# Rockxy Individual Contributor License Agreement

Version 2.0 — effective 2026-08-14

Thank you for contributing to Rockxy. This agreement defines the rights needed
...
`LocNguyenHuu` and contactable at `rockxyapp@gmail.com` (the **Project Owner**).
...
submit to the Project Owner for inclusion in Rockxy, including code, tests,
...
**Rockxy Material** means the Rockxy software, documentation, and related
materials to which the Contribution is submitted.

**Submission Date** means, for a given Contribution, the date on which you first
submit that Contribution to the Project Owner. For a Contribution submitted
through a pull request, the Submission Date is the date that pull request is
opened.
...
Rockxy Material, in source or object form.

This grant includes the right to license the Contribution under open-source,
source-available, commercial, or proprietary terms, including in Community,
Pro, Enterprise, embedded, hosted, and white-label distributions of Rockxy.
...
Contribution and your Contribution in combination with the Rockxy Material to
...
If the Project Owner includes your Contribution in any Rockxy Material or
distribution, the Project Owner will also license that Contribution under the
license used for the public Rockxy source edition on the Submission Date. As
...
## 8. Assignment and future Rockxy entity

The Project Owner may assign this agreement and the rights granted under it to
an entity that acquires, succeeds to, or operates the Rockxy project or
...
not transfer this agreement separately from the Rockxy project or business.
...
the Rockxy contribution workflow from the GitHub account associated with your
...
acceptance as described in [CLA-PRIVACY.md](CLA-PRIVACY.md).

Acceptance of this version applies to the Contribution or Contributions in the
pull request in which you post the assent statement and to each Contribution you
submit afterward while this version is in effect. A material amendment requires a
new version and new acceptance; it will not be applied retroactively merely by
...
Nothing in this agreement grants rights to Rockxy names, logos, or trademarks.
