# Rockxy Corporate Contributor License Agreement

Version 1.0 — effective 2026-08-14

This agreement must be completed by an authorized representative of an entity
that owns or controls Contributions submitted to Rockxy. Contact
`rockxyapp@gmail.com` to execute it and register authorized contributors.

## 1. Parties

This agreement is between the legal entity identified in the signature block
(**Entity**) and **Nguyen Huu Loc**, an individual also known publicly as
**Stephen**, the Rockxy maintainer identified by GitHub account
`LocNguyenHuu` and contactable at `rockxyapp@gmail.com` (the **Project Owner**).
“Project Owner” includes a permitted successor or assignee under Section 7.
...
Contribution, alone or as part of Rockxy Material, in source or object form.

This grant includes licensing under open-source, source-available, commercial,
or proprietary terms, including Community, Pro, Enterprise, embedded, hosted,
and white-label Rockxy distributions.
...
If the Project Owner includes a covered Contribution in any Rockxy Material or
distribution, the Project Owner will also license that Contribution under the
license used for the public Rockxy source edition on the Submission Date,
...
acquires, succeeds to, or operates the Rockxy project or business, provided
that entity assumes in writing the Project Owner’s obligations, including
Section 5. The agreement may not be transferred separately from the Rockxy
project or business.
...
- Name: Nguyen Huu Loc (also known publicly as Stephen)
- Signature:
- Date:
