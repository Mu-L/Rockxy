...
enum KeyboardShortcutCatalog {
    static let sections: [KeyboardShortcutSection] = [
        ...
        KeyboardShortcutSection(id: "main", title: "Main Capture", shortcuts: [
            ...
            row("main.last", "Main Capture", "Jump to the last visible row", "⌘↓", "Focused request table", nil, nil),
        ...
        KeyboardShortcutSection(id: "rules", title: "Rules Windows", shortcuts: [
            row("rules.breakpoint.new", "Breakpoint Rules", "New Breakpoint rule", "⌘N", "Breakpoint Rules window", nil, nil),
            row("rules.breakpoint.edit", "Breakpoint Rules", "Edit the selected Breakpoint rule", "⌘↩", "Breakpoint Rules window", nil, nil),
            ...
            row("rules.toggle", "Other Rules Windows", "Toggle selected rule enabled state", "↵ / Space", "Focused non-Breakpoint rules list", nil, nil),
